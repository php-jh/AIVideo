...
class VoiceGenerator:
    ...
    def generate_dialogue(self, text: str, character: str,
        ...
        Returns:
            音频时长（秒）
        """
        voice = self.male_voice if gender == "male" else self.female_voice
        ...
        try:
            for i, d in enumerate(scene.dialogues):
                ...
                self.generate_dialogue(
                    d["line"], d["character"],
                    d.get("gender", "male"), temp_path, on_progress
                )
    ...
    def _merge_narration_and_dialogues(self, scene, output_dir: str,
        ...
        try:
            ...
            for i, d in enumerate(scene.dialogues):
                ...
                self.generate_dialogue(
                    d["line"], d["character"],
                    d.get("gender", "male"), dialogue_path, on_progress
                )
    ...
    def generate_all_audio(self, scenes, output_dir: str,
