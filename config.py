...
DEFAULT_CONFIG = {
    ...
    # 分镜图生图时相对定妆照的变化幅度，越小越像同一人（0.25~0.55）
    "character_scene_img2img_strength": 0.4,
    "tts_voice_narrator": "zh-CN-YunxiNeural",  # 旁白音色
    "tts_voice_male": "zh-CN-YunxiNeural",  # 男角色音色
    "tts_voice_female": "zh-CN-XiaoxiaoNeural",  # 女角色音色
    "video_width": 1080,
    "video_height": 1920,
    "video_fps": 24,
    # 画面风格：live_action 真人纪实；anime_cartoon 2D 动漫（角色会动、对话镜头）
    ...
    "video_mode": "animated",
    # 动态片段：siliconflow=云端图生视频（举手/说话等更像动画）；local=本机轻量动效（无 GPU 可备用）
    "video_animated_backend": "siliconflow",
...
CONFIG_VALIDATORS = {
    ...
    "video_animated_backend": lambda x: x in ("siliconflow", "local"),
}
